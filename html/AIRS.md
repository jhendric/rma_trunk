...
The data is distributed in [HDF-4](http://www.hdfgroup.org/) format,
...
<div>
  ...
  along\_track\_thin    integer                  provides ability to thin the data by keeping only every Nth row. e.g. 4 == keep only every 4th row.                                                                                                                                                                                                                                   
